...
export default function Sidebar(props: sidebarType) {
    ...
    return (
        <>
            ...
            <div className="container col-span-1 bg-white p-10 border-r border-gray-primary h-screen sticky top-0">
                        ...
                        <div className='absolute bottom-0 mt-7 py-10 pr-32 '>
                                {showMore &&
                                    <div data-testid="more-content" className='absolute -top-44'>
                                        <li className="flex mt-3 justify-between border-b border-gray-primary py-3 cursor-pointer">
                ...
                {searchButtonClicked && 
                    <div className="absolute left-full inset-y-0 duration-100 ease-in-out border-transparent">
